...
write(
  ...
  JSON.stringify(
    {
      "//": "GENERATED by tools/build-geo.mjs — do not edit. Server-only: centroids feed distance/bearing (§7), tiers feed the schedule. The client copy is site/data/countries.min.json and deliberately lacks all of this.",
      sources,
