...
export const PRESETS: readonly Preset[] = [
  ...
  // belongs in a day. Five at six guesses each is the length of "Quintal",
  // which is the card this one is shaped like in every other way too.
  freeForAll("quem-nasceu-onde", "Quem nasceu onde?", "Cinco pessoas, cinco países de nascimento. Seis tentativas cada.", {
