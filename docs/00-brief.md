...
| D-23 | **Owner leaves or deletes account → ownership passes to the longest-standing remaining admin/organizer; if none, to the longest-standing member, who is promoted to organizer.** Last member leaving deletes the group and its pending invites. | A group without an owner cannot invite or remove anyone; deleting a group with people in it would be hostile; the new owner needs the rights the role implies. |
